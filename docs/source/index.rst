...
This implementation is `hosted on
GitHub <https://github.com/esnet/pypond>`__.

Documentation
-------------

The `main project link <http://software.es.net/pond/>`__ has extensive
...
duplicate that documentation here since the python implementation
follows the same API and uses the same structures.
